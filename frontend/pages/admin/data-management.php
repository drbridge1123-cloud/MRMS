    ...
    <div x-show="activeTab === 'export'" x-cloak>
        <div class="bg-white rounded-xl shadow-sm border border-v2-card-border p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                ...
                <div @click="toggleExport('insurance-companies')"
                     class="relative border-2 rounded-xl p-6 cursor-pointer transition-all hover:shadow-md text-center"
                     :class="selectedExports.includes('insurance-companies') ? 'border-gold bg-v2-bg' : 'border-v2-card-border bg-white hover:border-v2-card-border'">
                    <div x-show="selectedExports.includes('insurance-companies')" class="absolute top-3 right-3">
                        <svg class="w-5 h-5 text-gold" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                    </div>
                    ...
                    <div class="font-semibold text-v2-text">Insurance</div>
                    <div class="text-xs text-v2-text-light mt-1">Insurance companies</div>
                </div>

                <!-- Adjusters Card -->
                <div @click="toggleExport('adjusters')"
                     class="relative border-2 rounded-xl p-6 cursor-pointer transition-all hover:shadow-md text-center"
                     :class="selectedExports.includes('adjusters') ? 'border-gold bg-v2-bg' : 'border-v2-card-border bg-white hover:border-v2-card-border'">
                    <div x-show="selectedExports.includes('adjusters')" class="absolute top-3 right-3">
                        <svg class="w-5 h-5 text-gold" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                    </div>
                    ...
                    <div class="font-semibold text-v2-text">Adjusters</div>
                    <div class="text-xs text-v2-text-light mt-1">Insurance adjusters</div>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-v2-card-border p-6">
            ...
            <div class="mb-6">
                ...
                <div class="flex gap-3">
                    ...
                    <button @click="importType = 'insurance-companies'"
                            class="flex items-center gap-2 px-4 py-2.5 border-2 rounded-lg transition-all text-sm font-medium"
                            :class="importType === 'insurance-companies' ? 'border-gold bg-v2-bg text-gold' : 'border-v2-card-border text-v2-text-mid hover:border-v2-card-border'">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                        </svg>
                        Insurance
                    </button>
                    <button @click="importType = 'adjusters'"
                            class="flex items-center gap-2 px-4 py-2.5 border-2 rounded-lg transition-all text-sm font-medium"
                            :class="importType === 'adjusters' ? 'border-gold bg-v2-bg text-gold' : 'border-v2-card-border text-v2-text-mid hover:border-v2-card-border'">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                        </svg>
                        Adjusters
